...
echo.  [0m
echo.
echo                                               [4mPLAN OF ACTION:[0m
echo.
echo [4m1][0m Use RKill.exe (or if it doesnt work a renamed version of it).
echo     RKill is a tool that finds malware, and stops it from running. That way it cannot reinstall itself or copy itself
echo     any more.
echo.
echo [4m2][0m Use the Emsisoft Emergency Kit.
...
echo.
echo [42m[4mTo Get Started Press Y to agree to the statement.[0m
choice /c "YN"
if %errorlevel%==2 exit
cls
echo [42mRunning Rkill.exe In a new window . . .  Let it do it's stuff.[0m
...
echo.
echo [4mONCE RKILL IS COMPLETE OR IS ENABLING FIREWALL[0m please press any key.
echo.
pause
...
echo [97mNote: If you wish to use the command line version, close the Emsisoft window and press N.[0m
